...
class ImplementationGeneratorSpec extends FreeSpec with Matchers {
  ...
  lazy val `GET /contacts/individual/{contacts-id}` = (
    ...
    """def `GET /contacts/individual/{contacts-id}`(`contacts-id`: String): F[IndividualContact]"""
  )

  lazy val `PUT /contacts/individual/{contacts-id}` = (
    RouteDefinitions.`PUT /contacts/individual/{contacts-id}`,
    """def `PUT /contacts/individual/{contacts-id}`(`contacts-id`: String, body: IndividualContact): F[IndividualContact]"""
  )

  lazy val `DELETE /contacts/individual/{contacts-id}` = (
    RouteDefinitions.`DELETE /contacts/individual/{contacts-id}`,
    """def `DELETE /contacts/individual/{contacts-id}`(`contacts-id`: String): F[Unit]"""
  )

  lazy val `GET /contacts/organization/{contacts-id}/addresses` = (
    RouteDefinitions.`GET /contacts/organization/{contacts-id}/addresses`,
    """def `GET /contacts/organization/{contacts-id}/addresses`(`contacts-id`: String): F[Address]"""
  )
  ...
  lazy val `POST /contacts/organization/{contacts-id}/addresses` = (
    ...
    """def `POST /contacts/organization/{contacts-id}/addresses`(`contacts-id`: String, body: Address): F[Address]"""
  )
  ...
  lazy val `GET /contacts/organization/{contacts-id}/addresses/{address-id}` = (
    ...
    """def `GET /contacts/organization/{contacts-id}/addresses/{address-id}`(`contacts-id`: String, `address-id`: String): F[Address]"""
  )
  ...
  lazy val `PUT /contacts/organization/{contacts-id}/addresses/{address-id}` = (
    ...
    """def `PUT /contacts/organization/{contacts-id}/addresses/{address-id}`(`contacts-id`: String, `address-id`: String, body: Address): F[Address]"""
  )
  ...
  lazy val `DELETE /contacts/organization/{contacts-id}/addresses/{address-id}` = (
    ...
    """def `DELETE /contacts/organization/{contacts-id}/addresses/{address-id}`(`contacts-id`: String, `address-id`: String): F[Unit]"""
  )
  ...
  lazy val `GET /contacts/individual?query1&query2&optional1&optional2&list1&optional-list1` = (
    ...
    """def `GET /contacts/individual`(list1: List[Int], `optional-list1`: Option[List[String]], optional1: Option[String], optional2: Option[Int], query1: String, query2: Int): F[IndividualContact]"""
  )
  ...
  lazy val `POST /contacts/individual?query1&query2&optional1&optional2&list1&optional-list1` = (
    ...
    """def `POST /contacts/individual`(list1: List[Int], `optional-list1`: Option[List[String]], optional1: Option[String], optional2: Option[Int], query1: String, query2: Int, body: IndividualContact): F[IndividualContact]"""
  )
  ...
  lazy val `GET /contacts/individual/{contacts-id}?optional1&optional2` = (
    ...
    """def `GET /contacts/individual/{contacts-id}`(`contacts-id`: String, optional1: Option[String], optional2: Option[Int]): F[IndividualContact]"""
  )
  ...
  lazy val `PUT /contacts/individual/{contacts-id}?optional1&optional2` = (
    ...
    """def `PUT /contacts/individual/{contacts-id}`(`contacts-id`: String, optional1: Option[String], optional2: Option[Int], body: IndividualContact): F[IndividualContact]"""
  )
  ...
  lazy val `GET /contacts/organization/{contacts-id}/addresses?query1&query2` = (
    ...
    """def `GET /contacts/organization/{contacts-id}/addresses`(`contacts-id`: String, query1: String, query2: Int): F[Address]"""
  )
  ...
  lazy val `POST /contacts/organization/{contacts-id}/addresses?query1&query2` = (
    ...
    """def `POST /contacts/organization/{contacts-id}/addresses`(`contacts-id`: String, query1: String, query2: Int, body: Address): F[Address]"""
  )
  ...
  lazy val `GET /contacts/organization/{contacts-id}/addresses/{address-id}?list1&list2` = (
    ...
    """def `GET /contacts/organization/{contacts-id}/addresses/{address-id}`(`contacts-id`: String, `address-id`: String, list1: List[String], list2: List[Int]): F[Address]"""
  )
  ...
  lazy val `PUT /contacts/organization/{contacts-id}/addresses/{address-id}?list1&list2` = (
    ...
    """def `PUT /contacts/organization/{contacts-id}/addresses/{address-id}`(`contacts-id`: String, `address-id`: String, list1: List[String], list2: List[Int], body: Address): F[Address]"""
  )
  ...
  lazy val `GET /contacts/individual?optional-list1&optional-list2` = (
    ...
    """def `GET /contacts/individual`(`optional-list1`: Option[List[String]], `optional-list2`: Option[List[Int]]): F[IndividualContact]"""
  )
  ...
  lazy val `POST /contacts/individual?optionaoListl1&optional-list2` = (
    ...
    """def `POST /contacts/individual`(`optional-list1`: Option[List[String]], `optional-list2`: Option[List[Int]], body: IndividualContact): F[IndividualContact]"""
  )
  ...
  lazy val `GET /contacts/individual/funny.,argument/type/?other:@funny&trait` = (
    ...
    """def `GET /contacts/individual/{funny.,argument}/{type}`(`funny.,argument`: String, `type`: String, `other:@funny`: String, `trait`: String): F[IndividualContact]"""
  )
}
